...
namespace Project1 {
	...
	/// <summary>
	/// Summary for BisectionFrom
	/// </summary>
	public ref class BisectionFrom : public System::Windows::Forms::Form
	{
	public:
		BisectionFrom(void)
		{
			InitializeComponent();
			this->button1->Click += gcnew System::EventHandler(this, &BisectionFrom::button1_click);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &BisectionFrom::textBox1_TextChanged);
			// 
			// button1
			// 
			...
			this->textBox2->TextChanged += gcnew System::EventHandler(this, &BisectionFrom::textBox2_TextChanged);
			// 
			// textBox3
			// 
			...
			this->textBox4->TextChanged += gcnew System::EventHandler(this, &BisectionFrom::textBox4_TextChanged);
			// 
			// textBox5
			// 
			...
			this->label2->Click += gcnew System::EventHandler(this, &BisectionFrom::label2_Click);
			// 
			// label3
			// 
			...
			this->label4->Click += gcnew System::EventHandler(this, &BisectionFrom::label4_Click);
			// 
			// label5
			// 
			...
			this->label5->Click += gcnew System::EventHandler(this, &BisectionFrom::label5_Click);
			// 
			// BisectionFrom
			// 
			...
			this->Load += gcnew System::EventHandler(this, &BisectionFrom::BisectionFrom_Load);
